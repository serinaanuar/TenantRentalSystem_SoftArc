                            ...
                            <>
                                ...
                                <Dropdown id="user">
                                    ...
                                    <Dropdown.Content>
                                        ...
                                        <Dropdown.Link href={route("maintenance.index")}>Maintenance Requests</Dropdown.Link>
                                        {auth.user?.role === "seller" && (
                                            <Dropdown.Link href={route("seller.maintenance.index")}>Manage Maintenance</Dropdown.Link>
                                        )}
